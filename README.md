...
Please note: when a country's data show an unusually high death rate for a specific cause of death, this is labeled as an 'outlier'. Countries with outlier causes are indicated in red. Multiple outliers means that there are multiple causes for which the data of this country show an unusually high death rate. 
